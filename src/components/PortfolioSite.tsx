                            ...
                            <div className="flex items-start space-x-4">
                                ...
                                <div>
                                    ...
                                    <div className="flex flex-wrap gap-2">
                                        {["Go", "C#", "Python", "PostgreSQL", "ООП", "SOLID", "GRASP", "Гексагональная архитектура", "XUnit", "Moq"].map((skill) => (
                                            <span key={skill} className="px-3 py-1 bg-gray-900 text-gray-300 text-sm rounded-full">
                        {skill}
                      </span>
                                        ))}
                                    </div>
                            ...
                            >
                                ...
                                <div className="flex flex-wrap gap-2">
                                    {project.tech.map((tech) => (
                                        <span key={tech} className="px-3 py-2 mr-1 mb-1 inline-flex items-center justify-center bg-gray-900 bg-opacity-60 backdrop-blur-sm border border-gray-800 text-gray-300 text-xs rounded-md hover:bg-gray-800 transition-colors">
                      <span className="w-3 h-3 rounded-full mr-2" style={{ backgroundColor: techColors[tech] || '#6b7280' }}></span>
                      <span>{tech}</span>
                    </span>
                                    ))}
                                </div>
